...
const RepliedCommentReplyForm = ({ commentId, name ,parentId}: Props) => {
  ...
  return (
    <div className="mt-4">
      <form onSubmit={handleReplySubmit} className="p-3 ms-5 md:ms-12 w-[325px] md:w-[500px] lg:w-[550px] bg-white shadow-md rounded-lg">
...
export default RepliedCommentReplyForm;
